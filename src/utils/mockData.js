...
export const mockConsoleLogs = [
  ...
  "[Sync] Running automated dataset sync with AWS Rekognition collection...",
  "[Sync] Synced 56 faces successfully, 0 errors",
  "[Pipeline] [Main Entrance] Capture trigger: burst (2 people detected)",
  "[AWS] Sent image to SearchFacesByImage: found match Alex Jones (98.4%)",
  "[AWS] Sent image to SearchFacesByImage: no matches in collection",
